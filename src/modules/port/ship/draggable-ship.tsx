...
import { useDrag, useTransitionEnd } from "/hooks";

import { Direction, shipDirection } from "/constants";
...
export const DraggableShip = observer(({
    ...
    const { dndController: { isOverPlayerField, dropShip } } = useRootStore();
    ...
    const shipClassNames = clsx("ship", `ship_${shipDirection[direction]}`, {
